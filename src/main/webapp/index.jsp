...
<body>
	...
	<h1 style="color: green; font-size: 40px;" align="center">jenkins tomcat</h1>
	<p style="color: plum; font-size: 40px;" align="center">jenkins is a ci/cd tool</p>
	<h1 style="color: yellow; font-size: 40px;" align="center">jenkins</h1>
	<h1 style="color: blue; font-size: 40px;" align="center">tomcat</h1>
